...
const productLinks: LinkItem[] = [
	{
		title: 'Free Minecraft Server',
		href: '#hero',
		description: '4GB DDR5, NVMe, 24/7 free hosting',
		icon: LayersIcon,
	},
	{
		title: 'KVM VPS Cloud',
		href: '#vps',
		description: 'High performance VPS with root access',
		icon: GlobeIcon,
	},
	{
		title: 'Web Control Panel',
		href: '#panel',
		description: 'Live console, files, backups & control',
		icon: CodeIcon,
	},
	{
		title: 'Modpacks & Plugins',
		href: '#features',
		description: '1-click Paper, Purpur, Fabric & Forge',
		icon: PlugIcon,
	},
	{
		title: 'Sub-User Permissions',
		href: '#panel',
		description: 'Invite staff with granular access',
		icon: UserPlusIcon,
	},
	{
		title: 'Bedrock Crossplay',
		href: '#included',
		description: 'GeyserMC for Java & mobile gamers',
		icon: GlobeIcon,
	},
];
...
const companyLinks: LinkItem[] = [
	{
		title: 'About KineticHost',
		href: '#hero',
		description: 'Next-gen Ryzen infrastructure',
		icon: Users,
	},
	{
		title: 'Player Reviews',
		href: '#reviews',
		description: 'Rated 5 stars by thousands',
		icon: Star,
	},
	{
		...
		href: '#included',
		icon: LayersIcon,
		description: 'DDR5 ECC RAM & Gen4 NVMe',
	},
];
